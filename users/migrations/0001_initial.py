# Generated by Django 5.0.3 on 2024-03-09 00:41
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(blank=True, max_length=13, validators=[django.core.validators.RegexValidator(code='invalid_phone', message='Invalid phone number', regex='^\\+201\\d{9}$')])),
                ('usertype', models.CharField(choices=[('customer', 'Customer'), ('vendor', 'Vendor')])),
                ('address', models.CharField(default='', max_length=100)),
                ('shopname', models.CharField(blank=True, default='', max_length=100)),
